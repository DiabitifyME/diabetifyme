...
const breakfastItems = [
    {
        name: 'Avocado toast',
        details: '251g • 502 kcal\n33g total fat • 43g carbs • 10g protein',
        image: require('../assets/images/toast.jpg'),
    },
    {
        name: 'Smoothie bowl',
        details: '314g • 261 kcal\n6g total fat • 53g carbs • 9g protein',
        image: require('../assets/images/bowl.jpg'),
    },
    {
        name: 'Oatmeal with berries',
        details: '208g • 187 kcal\n4g total fat • 37g carbs • 6g protein',
        image: require('../assets/images/oatmeal.jpg'),
    },
    {
        name: 'Greek yogurt',
        details: '255g • 135 kcal\n5g total fat • 10g carbs • 20g protein',
        image: require('../assets/images/yogurt.jpg'),
    },
];
...
const BreakfastScreen = ({ navigation }) => {
    ...
    return (
        <ScrollView className="flex-1 bg-[#FFF3CD] pt-12">
            ...
            {/* Title */}
            <View className="px-6">
                <Text className="text-2xl font-bold text-gray-800 mt-20">Breakfast</Text>
            </View>
            ...
            {/* Free Trial Section */}
            <Text className="text-lg font-bold text-gray-700 text-center mt-8 mb-10 pb-8">
