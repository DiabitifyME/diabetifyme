...
export default function NutritionSubscribeScreen({ navigation }) {
    ...
    return (
        <View className="flex-1 bg-white">
            ...
            >
                ...
                <Text className="text-center text-xl font-semibold mt-56 bottom-20">
                    "Fuel Your Day Right —{"\n"}Premium Recipes Await You!"
                </Text>
            </LinearGradient>
            <View className="space-y-6">

                <TouchableOpacity className="flex-row justify-between items-center bg-white-100 rounded-xl px-16 py-8 border border-blue-100 mb-12 top-20 self-center ">
                ...
                <TouchableOpacity className="flex-row justify-between items-center bg-white-100 rounded-xl px-12 py-8 border border-blue-100 mb-12 top-20 self-center ">
                    <View className="flex-row items-center space-x-2">
            ...
            <TouchableOpacity className="flex-row justify-between items-center bg-[#FFF3CD] rounded-xl px-24 py-6 mb-12 top-20 self-center ">
                <View className="flex-row items-center space-x-2">
                    <Text className="font-semibold text-gray-900 ml-2 text-center text-xl">continue</Text>
                </View>
            </TouchableOpacity>
        </View>
