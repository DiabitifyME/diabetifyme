...
const HomePage = () => {
    ...
    return (
        <ScrollView className="flex-1 bg-white px-5 pt-10">
            ...
            {/* Logo Section */}
            <View className="items-start mb-1 self-start right-16">
                <TouchableOpacity>
                    <Image source={require("../assets/images/martina.jpg")} className="w-48 h-24 resize-contain" />
                </TouchableOpacity>
            </View>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} className="pl-1 pr-2">
                    <View className="flex-row gap-x-4 mt-2">
                        ...
                        <View className="bg-[#E6F7FF] rounded-3xl px-5 py-4 w-45">
                            ...
                            <Image
                                source={require('../assets/images/pills.jpg')}  // << your pills image here
                        ...
                        <View className="bg-[#FFF5E6] rounded-3xl px-5 py-4 w-45">
                            <Image
                                source={require('../assets/images/pills.jpg')}
                                className="h-10 w-10 mb-2 self-center"
                            />
                            <Text className="text-sm font-bold text-black text-center mb-1">Tresiba</Text>
                            <Text className="text-xs text-gray-700 text-center">1x 10:00 PM</Text>
