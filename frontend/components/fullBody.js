...
const exercises = [
    {
        ...
        duration: '5 minutes',
        locked: false,
        thumb: require('../assets/images/fullbody1.jpg'),
    },
    {
        id: '2',
        title: 'Lunges',
        duration: '4 minutes',
        locked: true,
        thumb: require('../assets/images/fullbody2.jpg'),
    },
    {
        id: '3',
        title: 'Plank',
        duration: '5 minutes',
        locked: true,
        thumb: require('../assets/images/fullbody3.jpg'),
    },
];

export default function FullBodyScreen() {
    ...
    return (
        <View className="flex-1 bg-white">
            ...
            {/* Top Image */}
            <Image
                source={require('../assets/images/fullbody.jpg')} // your top yoga image
