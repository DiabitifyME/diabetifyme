...
const exercises = [
    {
        id: '1',
        title: 'Reclining to big toe',
        duration: '12 minutes',
        locked: false,
        thumb: require('../assets/images/yoga1.jpg'),
    },
    {
        id: '2',
        title: 'Cow pose',
        duration: '8 minutes',
        locked: true,
        thumb: require('../assets/images/yoga2.jpg'),
    },
    {
        id: '3',
        ...
        duration: '6 minutes',
        locked: true,
        thumb: require('../assets/images/yoga3.jpg'),
    },
];
...
export default function YogaScreen() {
    ...
    return (
        <View className="flex-1 bg-white">
            ...
            {/* Top Image */}
            <Image
                source={require('../assets/images/yoga.jpg')} // your top yoga image
            ...
            <View className="flex-1 px-4 py-16 " style={{ marginTop: -68 }}>
                <View className="bg-[#FFF3CD] flex-1 rounded-3xl pt-8 pb-6 px-6">
