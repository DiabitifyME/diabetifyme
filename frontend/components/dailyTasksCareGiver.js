...
import { View, Text, TouchableOpacity, ScrollView, Switch, Modal, TextInput, Alert, Platform } from 'react-native';
    ...
    return (
        <View className="flex-1 bg-gray-50">
            ...
            <View className="pt-16 px-6 pb-4 bg-white">
                ...
                <Text className="text-3xl font-bold text-center mt-6">Daily Tasks</Text>
                <Text className="text-gray-600 text-center mt-3 text-lg font-medium">
                        ...
                        <View className="border border-gray-200 rounded-xl p-4 mb-4 bg-white shadow-sm">
                            <View className="flex-row justify-between items-start mb-2">
                                ...
                                <TouchableOpacity
                                    ...
                                    className="ml-4"
                                >
                                    <View className={`w-6 h-6 rounded-full border-2 ${task.completed ? 'bg-green-500 border-green-500' : 'border-gray-300'}`}>
                                        {task.completed && (
                            ...
                            <View className="flex-row items-center justify-between mt-4">
                                ...
                                <View className="flex-row items-center">
                                    ...
                                    <Switch
                                        ...
                                        thumbColor={task.reminderEnabled ? '#10b981' : '#f3f4f6'}
                                    />
                                </View>
                            </View>
                        </View>
            ...
            {/* Floating Add Button */}
            <TouchableOpacity
                className="absolute bottom-6 right-6 bg-[#BDF2F5] p-5 rounded-full shadow-lg"
                    ...
                    >
                        <View className="bg-white rounded-xl p-6">
                            ...
                            <View className="flex-row justify-end space-x-3 mt-4">
                                ...
                                <TouchableOpacity
                                    className="px-4 py-2 bg-[#BDF2F5] rounded-lg"
