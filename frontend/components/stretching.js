...
const exercises = [
    {
        ...
        duration: '5 minutes',
        locked: false,
        thumb: require('../assets/images/stretching1.jpg'),
    },
    {
        id: '2',
        title: 'Child pose',
        duration: '4 minutes',
        locked: true,
        thumb: require('../assets/images/stretching2.jpg'),
    },
    {
        id: '3',
        title: 'Bridge',
        duration: '5 minutes',
        locked: true,
        thumb: require('../assets/images/stretching3.png'),
    },
];
...
export default function StretchingScreen() {
    ...
    return (
        <View className="flex-1 bg-white">
            ...
            {/* Top Image */}
            <Image
                source={require('../assets/images/stretching.jpg')} // your top yoga image
